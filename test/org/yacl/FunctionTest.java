...
public class FunctionTest extends TestCase {
    ...
    public void test1() {
        ...
        Function f = new HashFun(
            new Lambda() { public Object expression(Object x) { return (Integer) x * (Integer) x; } }
        );        
    ...
    public void testAdd() {
        ...
        Function f = new HashFun();
        f.add(new Maplet("fred","mary"));
        f.add(new Maplet("tom","jane"));
       
        assertTrue(f.size()==2);
        
        try { f.add(new Maplet("fred","mary")); fail("fred, mary"); } catch (Exception e) { assertTrue(true); }
        
        assertTrue(f.size()==2);
        
        try { f.add(new Maplet("tom","jane")); fail("tom, jane"); } catch (Exception e) { assertTrue(true); }
        
        assertTrue(f.size()==2);
        
        try { f.add(new Maplet("fred","jane")); fail("fred, jane"); } catch (Exception e) { assertTrue(true); }
...
//        System.out.println(actual);
    ...
    public void testCasting() {
        Relation<String, String> q = new HashRel<>();
        q.add("larry","jane");
        q.add("jeff","mary");
        q.add("jules","kim");
